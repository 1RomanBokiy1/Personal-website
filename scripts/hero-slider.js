...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const careerSlides = [
        { title: "ПРИСОЕДИНЯЙСЯ К КОМАНДЕ", desc: "Создавайте будущее гейминга вместе с нами" },
        { title: "LEVEL DESIGN TEAM", desc: "Проектирование игровых уровней" },
        { title: "FRONTEND TEAM", desc: "Разработка пользовательских интерфейсов" },
        { title: "BACKEND TEAM", desc: "Серверная логика и базы данных" },
        { title: "ARTIST TEAM", desc: "Визуальное оформление и концепт-арт" },
        { title: "ENGINEER TEAM", desc: "Разработка движка и оптимизация" },
        { title: "DEVELOPERS TEAM", desc: "Программирование игровой логики" },
        { title: "GAME DESIGN TEAM", desc: "Проектирование геймплея и механик" }
    ];
    ...
    function switchVideo(index) {
        ...
        // Останавливаем предыдущее и сбрасываем на начало
        if (previousVideo && previousVideo !== currentVideo) {
            previousVideo.pause();
            previousVideo.currentTime = 0; // сброс на начало
        ...
        if (currentVideo) {
            currentVideo.currentTime = 0; // начинаем с начала
